...
<h3 class="card-title">Registrar Cuentas</h3>
</div>

 
<form method="GET" action="{{route("cuentas.register")}}">
                @csrf
<div class="card-body">
...
<input required autocomplete="off" name="cedula" class="form-control" type="text" placeholder="cedula">
...
<input required autocomplete="off" name="cuenta" class="form-control" type="text" placeholder="cuenta Bancaria">
