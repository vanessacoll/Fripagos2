...
<div class="row h-100">
    <div class="col-lg-5 col-12">
        <div id="auth-left">
            ...
            <p class="auth-subtitle mb-3">Inicie sesión con los datos que ingresó durante el registro.</p>
...
@enderror
            ...
            <div class="text-center mt-5 text-lg fs-4">
                <p class="text-gray-600">¿No tienes una cuenta? <a href="{{ route('register') }}" class="font-bold link">Regístrate</a>.</p>

                 @if (Route::has('password.request'))
                   <p> <a class="font-bold link" href="{{ route('password.request') }}">
